#coding: utf-8
print("-----")
print("1. O cabeçalho em script é: #!/usr/bin/env python ou #!/usr/bin/python para linux. Não é necessário header no Windows")
print("-----")
# print("2. Para não aparecer o erro (SyntaxError: Non-ASCII character), use essa linha logo abaixo do cabeçalho: #coding: utf-8")
# print("-----")
# print("3. Os comentários começam com: #")
# print("-----")
# print("4. Para imprimir na tela, ex.: print(Olá, mundo!")
# print("-----")
# print("5. Não precisa do ';' no final, mas coloquei aqui e não apresentou erro;");
# print("-----")
# print("6. Pode ter comentários no meio da linha como aqui e não aparece") # comentário
# print("-----")
# variavel = "Minha variável"
# print("7.", variavel)
# print("-----")
# print("8. Cria-se variáveis assim: variavel = 'Minha Variável', pode usar aspas simples ou duplas")
# print("-----")
# soma = 8 + 8;
# print("9. Operações aritméticas (soma +, subtração -, multiplicação *, divisão / ): print 8 + 8 = ", soma)
# print("9.1. Por exemplo --> soma = 8 + 8 --> Armazena o resultado na variável soma")
# print("9.2. Por exemplo --> print(8 + 8) --> Imprime na tela a soma do resultado")
# print("-----")
# print("10. Para concatenar strings basta usar o +, ex.: print 'Pala'+'vra'")
# print('Pala'+'vra')
# print("-----")
...
# print('str = raw_input("Insira seu nome: ") "A função raw_input está em desuso');
